...
<section class="lead-page">
  ...
  <div class="lead-body">
    <p class="lead-intro">Looking for cow race gravel screening or farm river gravel screening in Australia? If you have a farm river, you already have metal. Screen it on the terrace, knock the cobbles off, and use the rounded riverbed stone for races, tracks and yards — it packs harder under cows than sharp crushed product you buy in.</p>
    ...
    <div class="lead-close">
      ...
      <p>Tell us what you are screening and which loader or excavator you run. We will quote 100 mm mesh plus a filling screen, from the Pro Screen Australia Australian stock — supply nationwide. Prefer to view machines first? <a href="/for/view-in-your-area" style="color:#006a9a;font-weight:600;">viewing in your area details</a>.</p>
      <div class="cta-buttons lead-cta">
        <a href="tel:+61433045045" class="cta-primary">Call +61 433 045 045</a>
        <a href="/contact" class="cta-secondary">Contact Us</a>
        <a href="https://wa.me/61433045045" class="cta-secondary">WhatsApp Rob</a>
      </div>
      <p class="lead-note" style="margin-top: 18px;"><a href="/screening-recommendation#farm-filling" style="color:#006a9a;font-weight:600;">Mesh size guide</a> · <a href="/for/aggregate-and-road-metal" style="color:#006a9a;font-weight:600;">Aggregate &amp; road metal</a></p>
    </div>
  </div>
</section>
`
